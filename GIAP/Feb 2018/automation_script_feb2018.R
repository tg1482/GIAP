...
giap <- read_excel("Feb 2018/feb2018data.xlsx")
######################
...
for(name in hospital.names){
 render("GIAP Feb 2018 Individual Report.Rmd",
         output_file=paste0("C:/Users/tg1482/Desktop/GIAP/Feb 2018/results/", name, ".html"))
}
######################