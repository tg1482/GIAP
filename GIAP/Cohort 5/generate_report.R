...
giap <- read_sav("Cohort 5/data/Fall 2019 Data.sav")
response <- read.csv("Cohort 5/data/response_rates.csv")
######################
...
for(name in hospital.names){
  render("Cohort 5/Report-Template-Cohort-5.Rmd", 
         output_file = paste0("Cohort 5/results/", name, ".html"))
}
######################
