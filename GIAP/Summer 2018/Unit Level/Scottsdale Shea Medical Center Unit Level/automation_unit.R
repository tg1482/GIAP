...
for(name in unit.names){
  render("Summer 2018/Unit Level/Scottsdale Shea Medical Center Unit Level/Scottsdale Shea Medical Center.Rmd", 
         output_file = paste0("Summer 2018/Unit Level/Scottsdale Shea Medical Center Unit Level/Scottsdale Shea Medical Center Results/", name, ".html"))
}