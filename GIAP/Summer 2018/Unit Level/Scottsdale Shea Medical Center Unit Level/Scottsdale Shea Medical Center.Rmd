...
knitr::opts_chunk$set(echo = FALSE, message=FALSE, warning=FALSE, comment=NA, fig.width = 6, 
                      fig.asp = 0.618, out.width = "80%", fig.align = "center", fig.show='hold')
```
...
We use the quality improvement convention of the red, yellow and green stop light colors to present the GIAP results. Where applicable, the mean score for the hospital and unit are marked with an asterisks (*). As you review the diagrams, yellow and green denote higher performance on each measure.   
...
36 NICHE member hospitals participated in the `r cohort` GIAP survey. Within the 36 hospitals, 6924 nurses were eligible to participate. We received complete data from 2959 respondents, which equates to a 42.73% response rate.

**Data analysis**

The data were pooled across participating hospitals. We analyzed the hospital and individual unit level data using descriptive statistics.
