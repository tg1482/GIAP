...
The results of the GIAP for the October 2018 cohort suggests that nurses' knowledge regarding evidence-based practices to care for older adults is aligned with national trends [@author3]. There are opportunities to improve nurses' knowledge to both assess and use evidence-based interventions to address the problems of nutrition and hydration, incontinence, and managing behaviors associated with dementia and cognitive decline among the population of older adults receiving care at your hospital. Some poor practices or uncertainty regarding the best interventions to promote optimal health outcomes for older adults were also identified.
...
This diagram summarizes the participating hospitals' performance on the knowledge and practice environment components of the GIAP survey. The majority of hospitals participating in the October 2018 survey fall within the **Early Quadrant**. Your hospital is marked with a bold dot. 
...
profile_DF %>%
  ...
  geom_tile(aes(x = 0.60, y = 0.46, width = 0.24, height = 0.28), fill = "#6199AE") +
  geom_tile(aes(x = 0.60, y = 0.74, width = 0.24, height = 0.28), fill = "#E6E6E6") +
  geom_tile(aes(x = 0.84, y = 0.46, width = 0.24, height = 0.28), fill = "#E6E6E6") +
  geom_tile(aes(x = 0.84, y = 0.74, width = 0.24, height = 0.28), fill = "#6BAB8A") +
  geom_point(aes(shape = Hospital.Name == name), color = "black", size = 5) +
  geom_text(aes(x = 0.60, y = 0.46, label = "Early"), color = "white") +
  geom_text(aes(x = 0.60, y = 0.74, label = "Senior Friendly")) +
  geom_text(aes(x = 0.84, y = 0.46, label = "Senior Friendly")) +
  geom_text(aes(x = 0.84, y = 0.74, label = "Exemplary"), color = "white") +
  scale_x_continuous(limits=c(0.48,0.96), breaks = c(.60,.84), labels = c("Beginning","Advanced")) +
...
24 NICHE member hospitals participated in the October 2018 GIAP survey. Within the 24 hospitals, 4258 nurses were eligible to participate. We received complete data from 1740 respondents, which equates to a 40.87% response rate.
