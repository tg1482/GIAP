...
giap <- read_excel("Cohort 3/data/Oct 2018 Data.xlsx")
######################
...
for(name in hospital.names){
  render("Report-Template-Cohort-3.Rmd",
         output_file=paste0("C:/Users/tg1482/Desktop/GIAP/Cohort 3/results/", name, ".html"))
}
######################
