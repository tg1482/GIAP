...
giap <- read_excel("Cohort 2/data/summer2018AllData.xlsx")
######################
...
for(name in hospital.names){
  render("Report-Template-Cohort-2.Rmd",
         output_file=paste0("C:/Users/tg1482/Desktop/GIAP/Cohort 2/results/", name, ".html"))
}
######################
