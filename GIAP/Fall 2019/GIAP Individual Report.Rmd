...
This graph illustrates nurses’ views on organizational efforts to educate nurses and other staff on the care of older adults.
...
The number represents the percentage of the survey takers who believe that their institution has done a *Very Good* or *Excellent* job.

<center>
**Cohort Results**
</center>

```{r education_efforts_cohort, fig.width=7, fig.height= 5 , out.width = "75%"}
